...
/**
  ...
  */
class UserLogViewListAssigner(maxOutOfOrderness :Long) extends AssignerWithPeriodicWatermarks[UserLogViewListData]{
  ...
  /**
    ...
    * @return
    */
  override def extractTimestamp(element: UserLogViewListData, previousElementTimestamp: Long): Long = {
    //事件时间设置
